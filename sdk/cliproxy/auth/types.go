...
type ProviderHealthState struct {
	...
	LastSwitchToProvider string `json:"last_switch_to_provider,omitempty"`
	// LastSwitchToAuthID records the auth ID selected after a failover.
	LastSwitchToAuthID string `json:"last_switch_to_auth_id,omitempty"`
	// LastSwitchToAuthIndex records the auth index selected after a failover.
	LastSwitchToAuthIndex string `json:"last_switch_to_auth_index,omitempty"`
}
