...
func (s *Server) registerManagementRoutes() {
	...
	adminMgmt.Use(s.mgmt.RequireRoles(managementauth.RoleAdmin))
	{
		...
		adminMgmt.GET("/codex-workers/session-affinity", s.mgmt.GetCodexWorkerSessionAffinity)
		adminMgmt.PUT("/codex-workers/session-affinity", s.mgmt.PutCodexWorkerSessionAffinity)
		adminMgmt.PATCH("/codex-workers/session-affinity", s.mgmt.PutCodexWorkerSessionAffinity)
