...
type Config struct {
	...
	// MaxRetryCredentials limits how many credentials may be tried for a single request retry cycle.
...
type CloakConfig struct {
	...
	// CacheUserID stabilizes the synthetic user identifier used by cloaking.
...
type ClaudeKey struct {
	...
	// OpusBaseOnly forces Claude Opus requests to use the base Opus model only.
	// Requests like claude-opus-4-6[1m] are rewritten to claude-opus-4-6 and
	...
	// Opus47To46 rewrites Claude Opus 4.7/4.8 requests to Claude Opus 4.6 for this provider.
...
type CodexKey struct {
	...
	// FastRecovery enables short exponential cooldowns for transient upstream errors.
